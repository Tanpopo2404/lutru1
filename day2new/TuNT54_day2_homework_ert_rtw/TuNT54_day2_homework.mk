###########################################################################
## Makefile generated for Simulink model 'TuNT54_day2_homework'. 
## 
## Makefile     : TuNT54_day2_homework.mk
## Generated on : Tue Apr 01 23:37:37 2025
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\TuNT54_day2_homework.exe
...
PRODUCT_NAME              = TuNT54_day2_homework
MAKEFILE                  = TuNT54_day2_homework.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\Admin\Desktop\Homework\day2new
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = TuNT54_day2_homework_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = TuNT54_day2_homework_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\TuNT54_day2_homework.exe
...
INCLUDES_BUILDINFO = $(START_DIR);$(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\TuNT54_day2_homework_ert_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=TuNT54_day2_homework -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\TuNT54_day2_homework_ert_rtw\TuNT54_day2_homework.c

MAIN_SRC = $(START_DIR)\TuNT54_day2_homework_ert_rtw\ert_main.c
...
{$(START_DIR)\TuNT54_day2_homework_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\TuNT54_day2_homework_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
