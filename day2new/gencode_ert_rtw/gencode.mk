###########################################################################
## Makefile generated for Simulink model 'gencode'. 
## 
## Makefile     : gencode.mk
## Generated on : Tue Apr 01 22:17:19 2025
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\gencode.exe
...
MODELREF_LINK_RSPFILE_NAME = gencode_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = gencode_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\gencode.exe
...
INCLUDES_BUILDINFO = $(START_DIR);$(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\gencode_ert_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=gencode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\gencode_ert_rtw\gencode.c $(START_DIR)\gencode_ert_rtw\gencode_data.c

MAIN_SRC = $(START_DIR)\gencode_ert_rtw\ert_main.c
...
OBJS = gencode.obj gencode_data.obj
...
{$(START_DIR)\gencode_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\gencode_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
